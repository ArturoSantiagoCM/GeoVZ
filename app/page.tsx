...
export default function Page() {
  ...
  /* ── Carga inicial + realtime INSERT y UPDATE ── */
  useEffect(() => {
    const cargar = async () => {
      try {
    ...
    const channel = supabase
      ...
      .on('postgres_changes', { event: 'UPDATE', schema: 'public', table: 'reportes' }, payload => {
        // Actualiza solo el reporte modificado en la lista, sin mover su posición
        setReportes(prev =>
              ...
              <>
                ...
                <div className="px-4 pb-6 space-y-2 border-t border-slate-100 pt-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <a href="https://redatudavenezuela.com" target="_blank" rel="noopener noreferrer"
                    ...
                    <a href="https://hospitalesenvenezuela.com" target="_blank" rel="noopener noreferrer"
